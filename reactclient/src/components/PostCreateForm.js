...
export default function PostCreateForm(props) {
    const initialFormData = Object.freeze({
        title: "Post x",
        content: "This is post x and it has some important content"
    })
    ...
    return (
        <div>
            <form className="w-100 px-5">
                ...
                <button onClick={handleSubmit} className="btn btn-large btn-dark w-100 mt-5">Submit</button>
                <button onClick={() => props.onPostCreated(null)} className="btn btn-large btn-secondary w-100 mt-3">Cancel</button>
